...
# Generated by qmake (2.01a) (Qt 4.6.3) on: Tue Dec 13 19:59:11 2011
...
SOURCES       = lab/glwidget.cpp \
		...
		game/projectile.cpp moc_glwidget.cpp \
		moc_mainwindow.cpp
OBJECTS       = glwidget.o \
		targa.o \
		glm.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/rollercoaster1.0.0/ && $(COPY_FILE) --parents lab/glwidget.h lib/targa.h lib/glm.h math/vector.h support/resourceloader.h support/mainwindow.h support/camera.h lib/targa.h sweepprune/SweepPruner.h sweepprune/CollisionPair.h sweepprune/BoundingBox.h game/gameengine.h game/gameobject.h game/beziercurve.h sweepprune/dimensionpoint.h game/particleemitter.h game/projectile.h .tmp/rollercoaster1.0.0/ && $(COPY_FILE) --parents lab/glwidget.cpp lib/targa.cpp lib/glm.cpp support/resourceloader.cpp support/mainwindow.cpp support/main.cpp support/camera.cpp sweepprune/SweepPruner.cpp sweepprune/CollisionPair.cpp sweepprune/BoundingBox.cpp game/gameengine.cpp game/gameobject.cpp game/beziercurve.cpp game/particleemitter.cpp game/projectile.cpp .tmp/rollercoaster1.0.0/ && $(COPY_FILE) --parents support/mainwindow.ui support/mainwindow.ui .tmp/rollercoaster1.0.0/ && (cd `dirname .tmp/rollercoaster1.0.0` && $(TAR) rollercoaster1.0.0.tar rollercoaster1.0.0 && $(COMPRESS) rollercoaster1.0.0.tar) && $(MOVE) `dirname .tmp/rollercoaster1.0.0`/rollercoaster1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/rollercoaster1.0.0
